...
export const fallbackJournalEntries = [
  {
    id: "journal-1",
    type: "JOURNAL" as const,
    slug: "best-birthday-cakes-in-mumbai",
    title: "Best Birthday Cakes in Mumbai for 2026 Celebrations",
    excerpt: "What birthday buyers in Mumbai actually care about before placing a cake order.",
    body: "The strongest birthday cake pages answer practical buying questions early: delivery slot clarity, message-on-cake inputs, eggless options, and whether the bakery can handle a theme request without turning the process into a long back-and-forth. For Mumbai buyers, convenience and reliability matter as much as the design itself.",
    imageUrl: null,
    published: true,
    sortOrder: 1,
    createdAt: new Date(),
  ...
  },
  {
    id: "journal-3",
    type: "JOURNAL" as const,
    slug: "cakes-and-chocolates-in-mumbai",
    title: "Where to Order Cakes and Chocolates Together in Mumbai",
  ...
  },
  {
    id: "journal-4",
    type: "JOURNAL" as const,
    slug: "eggless-cakes-in-mumbai-guide",
    title: "How to Choose Eggless Cakes in Mumbai Without Sacrificing Taste",
